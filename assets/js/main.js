...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var React = __webpack_require__(3),
	    Articles = __webpack_require__(1).Articles,
	    Article = __webpack_require__(1).Article,
	    Categories = __webpack_require__(2);
	...
	var App = React.createClass({displayName: "App",
	  ...
	  onSelectCategory: function (categoryId) {
	    this.setState({
	      isList: true,
	      articles: window._strings.articles.filter(function(article)  {
	  ...
	  onSelectArticle: function (articleId) {
	    this.setState({
	      isList: false,
	      selectArticle: this.state.articles.filter(function(article)  {
	  ...
	  render: function () {
	    ...
	    if (this.state.isList) {
	      content = React.createElement(Articles, {articles: this.state.articles, onSelect: this.onSelectArticle})
	    } else {
	      var isDetail = true;
	      content = React.createElement(Article, {article: this.state.selectArticle, isDetail: isDetail})
	    }

	    return (
	      React.createElement("div", null, 
	        React.createElement("header", null, 
	          React.createElement(Categories, {onSelect: this.onSelectCategory})
	        ), 
	        content
	      )
	    );
	...
	var Article = React.createClass({displayName: "Article",
	  ...
	  render: function () {
	    if (this.props.isDetail) {
	      return (
	        React.createElement("section", {className: "white-container"}, 
	          React.createElement("header", {style: "height:50px;"}, this.props.article.title), 
	          React.createElement("article", {style: "height:2000px;"}, this.props.article.content)
	        )
	      )
	    } else {
	      className = "article " + this.props.article.category.className;
	      return React.createElement("li", {className: className}, React.createElement("a", {onClick: this.onClick}, this.props.article.title))
	    }
	  }
	});
	...
	var Articles = React.createClass({displayName: "Articles",
	  ...
	  render: function () {
	    var articles = this.props.articles.map(function(article)  {
	      return React.createElement(Article, {article: article, isDetail: false, onClick: this.onSelect})
	    }.bind(this));

	    return (
	      React.createElement("section", {className: "white-container"}, 
	        React.createElement("ul", {className: "articles"}, 
	          articles
	        )
	      )
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Category = React.createClass({displayName: "Category",
	  ...
	  render: function () {
	    ...
	    return (
	      React.createElement("li", {className: className, onClick: this.onClick})
	    )
	  }
	});
	...
	var Categories = React.createClass({displayName: "Categories",
	  ...
	  render: function () {
	    var categories = this.state.categories.map(function(category)  {
	      return React.createElement(Category, {category: category, onClick: this.onSelect})
	    }.bind(this));
	    return (
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MobileSafariClickEventPlugin = __webpack_require__(45);
	var ReactBrowserComponentMixin = __webpack_require__(46);
	var ReactClass = __webpack_require__(8);
	var ReactComponentBrowserEnvironment =
	  __webpack_require__(35);
	var ReactDefaultBatchingStrategy = __webpack_require__(47);
	var ReactDOMComponent = __webpack_require__(36);
	var ReactDOMButton = __webpack_require__(48);
	var ReactDOMForm = __webpack_require__(49);
	var ReactDOMImg = __webpack_require__(50);
	var ReactDOMIDOperations = __webpack_require__(51);
	var ReactDOMIframe = __webpack_require__(52);
	var ReactDOMInput = __webpack_require__(53);
	var ReactDOMOption = __webpack_require__(54);
	var ReactDOMSelect = __webpack_require__(55);
	var ReactDOMTextarea = __webpack_require__(56);
	var ReactDOMTextComponent = __webpack_require__(14);
	var ReactElement = __webpack_require__(11);
	var ReactEventListener = __webpack_require__(57);
